...
import 'package:firebasecore/ui/views/group/group_add_member_page.dart';
...
class _GroupInfoState extends State<GroupInfo> {
  ...
  Future onLeaveGroup() async {
    if (!checkAdmin()) {
      ...
      await _firestore.collection('users').doc(_auth.currentUser!.uid).collection('groups').doc(widget.groupId).delete();
